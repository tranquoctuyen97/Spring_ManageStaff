                    ...
                    <div data-step="1" class="step-pane active">
                      <form action="form-wizard.html#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" class="form-horizontal group-border-dashed">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" placeholder="User name" class="form-control " disabled="disabled " value="${user.usename }">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="password" placeholder="Enter your password" class="form-control" value="${user.password }">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-3 control-label">Verify Password</label>
                          <div class="col-sm-6">
                            <input type="password" placeholder="Enter your password again" class="form-control" value="${user.password}">
                          </div>
                        </div>
                        <div class="form-group">
